...
public class RestApiController {
    ...
    @PostMapping(path = "/setMessageLong", consumes = {"application/json"})
    public void sendMassageLong(@RequestBody TMP2NET tmp2) throws Exception {
        TMP2NET tmp2NET = new TMP2NET(tmp2.message, tmp2.getIp(), tmp2.port, tmp2.getHeight(), tmp2.getWidth(), tmp2.getR(), tmp2.getG(), tmp2.getB());
        tmp2NET.sendMassageAnimation();
    }
